...
export class DelegateApprovalChanged extends ethereum.Event {
  get params(): DelegateApprovalChanged__Params {
    return new DelegateApprovalChanged__Params(this);
  }
}

export class DelegateApprovalChanged__Params {
  _event: DelegateApprovalChanged;

  constructor(event: DelegateApprovalChanged) {
    this._event = event;
  }
...
export class ClearingHouse__openPositionForResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class ClearingHouse__openPositionForInputParamsStruct extends ethereum.Tuple {
  get baseToken(): Address {
    return this[0].toAddress();
  }
...
export class ClearingHouse__quitMarketResult {
  value0: BigInt;
  value1: BigInt;
...
export class ClearingHouse extends ethereum.SmartContract {
  ...
  try_getDelegateApproval(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "getDelegateApproval",
      "getDelegateApproval():(address)",
      []
  ...
  openPositionFor(
    trader: Address,
    params: ClearingHouse__openPositionForInputParamsStruct
  ): ClearingHouse__openPositionForResult {
    let result = super.call(
      "openPositionFor",
      "openPositionFor(address,(address,bool,bool,uint256,uint256,uint256,uint160,bytes32)):(uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(trader), ethereum.Value.fromTuple(params)]
    );

    return new ClearingHouse__openPositionForResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_openPositionFor(
    trader: Address,
    params: ClearingHouse__openPositionForInputParamsStruct
  ): ethereum.CallResult<ClearingHouse__openPositionForResult> {
    let result = super.tryCall(
      "openPositionFor",
      "openPositionFor(address,(address,bool,bool,uint256,uint256,uint256,uint160,bytes32)):(uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(trader), ethereum.Value.fromTuple(params)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ClearingHouse__openPositionForResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  quitMarket(
    trader: Address,
    baseToken: Address
  ): ClearingHouse__quitMarketResult {
    let result = super.call(
      "quitMarket",
      "quitMarket(address,address):(uint256,uint256)",
      [
        ethereum.Value.fromAddress(trader),
    ...
    return new ClearingHouse__quitMarketResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_quitMarket(
    trader: Address,
    baseToken: Address
  ): ethereum.CallResult<ClearingHouse__quitMarketResult> {
    let result = super.tryCall(
      "quitMarket",
      "quitMarket(address,address):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ClearingHouse__quitMarketResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
...
export class Liquidate1Call extends ethereum.Call {
  get inputs(): Liquidate1Call__Inputs {
    return new Liquidate1Call__Inputs(this);
  }

  get outputs(): Liquidate1Call__Outputs {
    return new Liquidate1Call__Outputs(this);
  }
}

export class Liquidate1Call__Inputs {
  _call: Liquidate1Call;

  constructor(call: Liquidate1Call) {
    this._call = call;
  }
...
export class Liquidate1Call__Outputs {
  _call: Liquidate1Call;
...
export class OpenPositionForCall extends ethereum.Call {
  get inputs(): OpenPositionForCall__Inputs {
    return new OpenPositionForCall__Inputs(this);
  }

  get outputs(): OpenPositionForCall__Outputs {
    return new OpenPositionForCall__Outputs(this);
  }
}

export class OpenPositionForCall__Inputs {
  _call: OpenPositionForCall;

  constructor(call: OpenPositionForCall) {
    this._call = call;
  }
  ...
  get params(): OpenPositionForCallParamsStruct {
    return changetype<OpenPositionForCallParamsStruct>(
      this._call.inputValues[1].value.toTuple()
    );
  }
}

export class OpenPositionForCall__Outputs {
  _call: OpenPositionForCall;
...
export class OpenPositionForCallParamsStruct extends ethereum.Tuple {
  get baseToken(): Address {
    return this[0].toAddress();
  }
...
export class QuitMarketCall extends ethereum.Call {
  get inputs(): QuitMarketCall__Inputs {
    return new QuitMarketCall__Inputs(this);
  }

  get outputs(): QuitMarketCall__Outputs {
    return new QuitMarketCall__Outputs(this);
  }
}

export class QuitMarketCall__Inputs {
  _call: QuitMarketCall;

  constructor(call: QuitMarketCall) {
    this._call = call;
  }
...
export class QuitMarketCall__Outputs {
  _call: QuitMarketCall;
...
export class SetDelegateApprovalCall extends ethereum.Call {
  get inputs(): SetDelegateApprovalCall__Inputs {
    return new SetDelegateApprovalCall__Inputs(this);
  }

  get outputs(): SetDelegateApprovalCall__Outputs {
    return new SetDelegateApprovalCall__Outputs(this);
  }
}

export class SetDelegateApprovalCall__Inputs {
  _call: SetDelegateApprovalCall;

  constructor(call: SetDelegateApprovalCall) {
    this._call = call;
  }

  get delegateApprovalArg(): Address {
    return this._call.inputValues[0].value.toAddress();
  }
}

export class SetDelegateApprovalCall__Outputs {
  _call: SetDelegateApprovalCall;
