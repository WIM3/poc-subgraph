...
export class AccountBalance__settlePositionInClosedMarketResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
  ...
  getPositionNotional(): BigInt {
    return this.value0;
  }

  getOpenNotional(): BigInt {
    return this.value1;
  }

  getRealizedPnl(): BigInt {
    return this.value2;
  }

  getClosedPrice(): BigInt {
    return this.value3;
  }
}
...
export class AccountBalance extends ethereum.SmartContract {
  ...
  getLiquidatablePositionSize(
    ...
    let result = super.call(
      "getLiquidatablePositionSize",
      "getLiquidatablePositionSize(address,address,int256):(int256)",
      [
        ethereum.Value.fromAddress(trader),
        ethereum.Value.fromAddress(baseToken),
        ethereum.Value.fromSignedBigInt(accountValue)
      ]
    );
  ...
  try_getLiquidatablePositionSize(
    trader: Address,
    baseToken: Address,
    accountValue: BigInt
  ): ethereum.CallResult<BigInt> {
  ...
  settlePositionInClosedMarket(
    trader: Address,
    baseToken: Address
  ): AccountBalance__settlePositionInClosedMarketResult {
    let result = super.call(
      "settlePositionInClosedMarket",
      "settlePositionInClosedMarket(address,address):(int256,int256,int256,uint256)",
      [
        ethereum.Value.fromAddress(trader),
        ethereum.Value.fromAddress(baseToken)
      ]
    ...
    return new AccountBalance__settlePositionInClosedMarketResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_settlePositionInClosedMarket(
    trader: Address,
    baseToken: Address
  ): ethereum.CallResult<AccountBalance__settlePositionInClosedMarketResult> {
    let result = super.tryCall(
      "settlePositionInClosedMarket",
      "settlePositionInClosedMarket(address,address):(int256,int256,int256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new AccountBalance__settlePositionInClosedMarketResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
...
export class SettlePositionInClosedMarketCall extends ethereum.Call {
  get inputs(): SettlePositionInClosedMarketCall__Inputs {
    return new SettlePositionInClosedMarketCall__Inputs(this);
  }

  get outputs(): SettlePositionInClosedMarketCall__Outputs {
    return new SettlePositionInClosedMarketCall__Outputs(this);
  }
}

export class SettlePositionInClosedMarketCall__Inputs {
  _call: SettlePositionInClosedMarketCall;

  constructor(call: SettlePositionInClosedMarketCall) {
    this._call = call;
  }
...
export class SettlePositionInClosedMarketCall__Outputs {
  _call: SettlePositionInClosedMarketCall;
